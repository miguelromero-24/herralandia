...
<body>
<!-- Start of preheader -->
<table width="100%" bgcolor="#dbdbdb" cellpadding="0" cellspacing="0" border="0" id="backgroundTable"
                        ...
                        <table width="560" cellpadding="0" cellspacing="0" border="0" align="center"
                            ...
                            <tr>
                                <td align="center" valign="middle"
                                    style="font-family: Helvetica, arial, sans-serif; font-size: 10px;color: #303030;text-align:center;"
                                    st-content="viewonline">
                                    Mensaje del Administrador de Area Deportiva
                                </td>
                                <!-- Spacing -->
                            </tr>
                            <tr>
    ...
    <tr>
        <td>
            <table width="560" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                ...
                <tr>
                    <td width="100%">
                        <table bgcolor="#303030" width="560" cellpadding="0" cellspacing="0" border="0" align="center"
                               style="border-top-left-radius:5px;border-top-right-radius:5px;" class="devicewidth">
                            <tbody>
                            <!-- Spacing -->
                            <tr>
                                            ...
                                            <td width="174" height="60" align="left">
                                                <div class="imgpop">
                                                    <a target="_blank" href="#">
                                                        <img src="img/logo.png" alt="" border="0" width="174"
                                                             height="21"
                                    ...
                                    <table width="520" cellpadding="0" cellspacing="0" border="0" align="center"
                                        ...
                                        <tr>
                                            <td width="520" align="center" class="devicewidthinner">
                                                <img src="img/blog.jpg" alt="" border="0" width="520" height="200"
                                                     style="display:block; border:none; outline:none; text-decoration:none;"
                                                     class="blog">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #7a6e67; text-align:left; line-height: 24px;">
                                                Si usted cree que este correo es un ERROR, por favor elimine este correo
                                                y comunique el incidente a su administrador, o escribanos a:<br><a
                                                        href="">soporte@teo.com.py</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #7a6e67; text-align:left; line-height: 24px;">
                        ...
                        <table bgcolor="#303030" width="560" cellpadding="0" cellspacing="0" border="0" align="center"
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="60" height="40" align="right" vaalign="middle" border="0"
                                        ...
                                        <tr>
                                            <td width="22" height="22" align="left">
                                                <div class="imgpop">
                                                    <a target="_blank" href="#">
                                                        <img src="img/facebook.png" alt="" border="0" width="22"
                                                             height="22"
                                                             style="display:block; border:none; outline:none; text-decoration:none;">
                                                    </a>
                                                </div>
                                            ...
                                            <td width="22" height="22" align="right">
                                                <div class="imgpop">
                                                    <a target="_blank" href="#">
                                                        <img src="img/twitter.png" alt="" border="0" width="22"
                                                             height="22"
                                                             style="display:block; border:none; outline:none; text-decoration:none;">
                                                    </a>
                                                </div>
